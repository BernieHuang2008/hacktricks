...
> \[!CAUTION] **Security Alert**: Simplified DEP enrollment could potentially allow unauthorized device registration on the organization's MDM server if proper safeguards are not in place.
...
\{{#ref\}} macos-serial-number.md \{{#endref\}}
...
\{{#ref\}} enrolling-devices-in-other-organisations.md \{{#endref\}}
