...
> \[!TIP] These are the **values of the HackTricks Project**:
>
...
You can publicly thanks HackTricks teams for putting together all these resources publicly in a tweet mentioning [**@hacktricks\_live**](https://twitter.com/hacktricks_live).\
